...
locals {
      ...
      public_ip_resource_group = var.new-public-ip == "yes" ? "/subscriptions/${var.subscription_id}/resourceGroups/${azurerm_resource_group.managed-app-rg.name}" : "/subscriptions/${var.subscription_id}/resourceGroups/${split("/", var.existing-public-ip)[4]}"
}
